...
answer = Entry(root)
#answer = Label (root, bg="white", fg="white", width=10, borderwidth=10) #I used the label so that the person does not edit the answer
...
def button_add ():
    ...
    first_add = float (digit_1)
    second_add = float (digit_2)
...
# Buttons
button_add = Button(root,  borderwidth=10, font=("Consolas 15 bold"),text="Add", bg="green", fg="white", width=10, command=button_add)
button_clear = Button(root, text="Clear", borderwidth=10, font=("Consolas 15 bold"), bg="green", fg="white", width=10, command=button_clear)
button_exit = Button(root, text="Exit", borderwidth=10, font=("Consolas 15 bold"), bg="green", fg="white", width=10, command=button_exit)
